...
![alt text](https://github.com/V1ndl3R/CIT480/blob/master/assets/WEP-1.PNG "WEP-1")
...
![alt text](https://github.com/V1ndl3R/CIT480/blob/master/assets/WEP-2.PNG "WEP-2")
...
![alt text](https://github.com/V1ndl3R/CIT480/blob/master/assets/WEP-3.PNG "WEP-3")
	

Now all the traffic is in plaintext and you can view usernames and passwords.
![alt text](https://github.com/V1ndl3R/CIT480/blob/master/assets/WEP-4.PNG "WEP-4")
